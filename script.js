...
const audioWin = new Audio("./assests/sounds/assets_sounds_winning.wav");
const audioLose = new Audio("./assests/sounds/assets_sounds_losing.wav");
...
function reset() {
  ...
  imgUser.innerHTML = "<img src=./assests/images'" + player1 + ".png'>";
  imgPC.innerHTML = "";
}
...
function playPc() {
  ...
  player2 = opt[num];
  imgPC.innerHTML = "<img src=./assests/images'" + player2 + ".png'>";
  analyze();
}
